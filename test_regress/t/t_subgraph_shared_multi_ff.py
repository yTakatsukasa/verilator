...
test.file_grep(test.stats, r'Inst, Subgraph shared input captures\s+(\d+)', 10)
...
test.file_grep(test.stats, r'Scheduling, Subgraph NBA internal actives\s+(\d+)', 4)
test.file_grep(test.stats, r'Scheduling, Subgraph shared Order skips\s+(\d+)', 4)
