...
test.file_grep(test.stats, r"Scheduling, Subgraph order graph contract nodes\s+(\d+)", 2)
test.file_grep(test.stats, r"Scheduling, Subgraph order graph contract uses\s+(\d+)", 8)
