...
test.file_grep(test.stats, r"Scheduling, Subgraph V3Ast ordinary schedule contexts\s+(\d+)", 1)
test.file_grep(
    test.stats,
    r"Scheduling, Subgraph V3Ast ordinary schedule context instances\s+(\d+)",
    1,
)
