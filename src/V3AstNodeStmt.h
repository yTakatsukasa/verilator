...
class AstSubgraphCall final : public AstNodeStmt {
    // Temporary thin wrapper call, resolved to a shared V3Ast body immediately after V3Scope.
    // @astgen op1 := argsp : List[AstNodeExpr]
    uint32_t m_templateId;  // One-based specialization ID in V3SubgraphAst
