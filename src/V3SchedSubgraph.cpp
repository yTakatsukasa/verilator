...
// separates already partitioned NBA logic into per-instance helpers. The
// parent Order graph sees each helper through its boundary variable contract.
// Scope expansion and the earlier scheduling analyses remain unchanged.
//
//*************************************************************************
