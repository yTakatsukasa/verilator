...
public:
    ...
    enum en: uint8_t  {
        ...
        SUBGRAPH,       // Subgraph scheduling fallback
    ...
    const char* ascii() const VL_MT_SAFE {
        static const char* const names[] = {
            ...
            "STMTDLY", "SUBGRAPH", "SUPERNFIRST", "SYMRSVDWORD", "SYNCASYNCNET", "TICKCOUNT",
            "TIMESCALEMOD", "UNDRIVEN", "UNOPT", "UNOPTFLAT", "UNOPTTHREADS", "UNPACKED",
            "UNSATCONSTR", "UNSIGNED", "UNUSED", "UNUSEDGENVAR", "UNUSEDLOOP", "UNUSEDPARAM",
